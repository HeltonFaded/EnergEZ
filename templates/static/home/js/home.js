...
function moveCarousel(index) {
    ...
    const descricaoImagem = descricoes[descricaoId] || "Descrição não disponível";
    descricaoImagemElement.textContent = descricaoImagem;
